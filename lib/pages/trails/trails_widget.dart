                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(
                                'trail_details',
                                queryParameters: {
                                  'trail': serializeParam(
                                    listViewTrailsRecord,
                                    ParamType.Document,
                                  ),
                                }.withoutNulls,
                                extra: <String, dynamic>{
                                  'trail': listViewTrailsRecord,
                                },
                              );
                            },
                            child: Card(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 3.0, 0.0, 3.0),
                                      child: Hero(
                                        tag: listViewTrailsRecord.image,
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '${listViewTrailsRecord.length.toString()}m',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium,
                                                ),
